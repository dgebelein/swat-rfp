...
//		public ModelPR(Weather weather, SimParameters explicitParams = null, SimParameters locationParams = null) : base(weather, explicitParams, locationParams)
//		{
//			//InitParamDefaults();
...
//			p.InitItem("pr.DevFlyTmax", 35.0, typeof(double), 32.0, 45.0, "Entwicklung Fliege: Temperaturmaximum");
//			p.InitItem("pr.DevFlyTopt", 30.0, typeof(double), 15.0, 32.0, "Entwicklung Fliege: Temperaturoptimum");
...
//			p.InitItem("pr.DevWiPupaTmax", 29.97, typeof(double), 29.0, 40.0, "Entwicklung Winterpuppe: Temperaturmaximum");
//			p.InitItem("pr.DevWiPupaTopt", 20.27, typeof(double), 15.0, 29.0, "Entwicklung Winterpuppe: Temperaturoptimum");
//			p.InitItem("pr.DevWiPupaQ", 1.731, typeof(double), 1.1, 2.5, "Entwicklung Winterpuppe: Steilheit");
//			p.InitItem("pr.DevWiPupaL", 0.006, typeof(double), 0.0, 0.1, "Entwicklung Winterpuppe: Konvexität linke Flanke");
//			p.InitItem("pr.DevWiPupaKmax", 0.0316, typeof(double), 0.015, 0.2, "Entwicklung Winterpuppe: max. tägl. Entwicklungsrate");
...
//			//p.InitItem("pr.IsWr", true, typeof(bool), 0.0, 1.0, "Flug durch Wind eingeschränkt?");
//			//p.InitItem("pr.WrThr", 3.0, typeof(double), 1.0, 10.0, "Grenzwert (m/s) für Flughemmung");
//			//p.InitItem("pr.WrInc", 0.25, typeof(double), 0.1, 0.9, "Anstieg Flughemmung pro zusätzl. m/s");
...
//			p.InitItem("pr.VpdThr", 8.5, typeof(double), 1.0, 25.0, "Grenzwert (hPa) für Flughemmung");
//			p.InitItem("pr.VpdInc", 0.25, typeof(double), 0.01, 0.9, "Anstieg Flughemmung pro zusätzl. hPa");
...
//			p.InitItem("pr.AestThr", 20.3, typeof(double), 15.0, 35.0, "Temperaturschwelle für Auslösen d. Ästivation");
//			p.InitItem("pr.AestVar", 3.0, typeof(double), 0.0, 10.0, "Streuungsfaktor Ästivation");     
//			p.InitItem("pr.AestDropDiff", 2.2, typeof(double), 0.0, 5.0, "Differenz für Aufheben d. Ästivation");
...
//		{
//			WeatherData.AirTempAdjustment = (Double)_workingParams.GetValue("pr.AdjAir");

//			WeatherData.SoilTempAdjustment = (Double)_workingParams.GetValue("pr.AdjSoil");
//			//WeatherData.WindSpeedAdjustment = (Double)_workingParams.GetValue("pr.AdjWind");
//			WeatherData.UseSummerSoil = (bool)_workingParams.GetValue("pr.UseSummerSoil");

//			_simAirTemps = WeatherData.GetSimAirTemp();
//			_simSoilTemps = WeatherData.GetSimSoilTemp();
//			_simVPD = WeatherData.GetSimVpd();
...
//			//_prognStartIndex = WeatherData.GetPrognStartIndex(startIndex);
...
//				switch (stage)
//				{
//					case 0: t = (Double)_workingParams.GetValue("pr.TransEgg"); break;
//					case 1: t = (Double)_workingParams.GetValue("pr.TransLarva"); break;
//					case 2: t = (Double)_workingParams.GetValue("pr.TransPupa"); break;
//					case 3: t = (Double)_workingParams.GetValue("pr.TransFly"); break;
//					case 4: t = (Double)_workingParams.GetValue("pr.TransWiPupa"); break;
