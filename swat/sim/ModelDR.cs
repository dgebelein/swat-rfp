...
namespace swat.sim
{
	class ModelDR : ModelBase
	{
		...
		public ModelDR(WorkspaceData workspace,SimParamData explicitParams = null) : base(workspace, explicitParams)
		{
			//InitParamDefaults();
		...
		public  override SimParamData GetDefaultParams()
		{
			...
			p.InitItem("dr.DiaDate", 225, typeof(int), 200.0, 300.0, "frühester Eintritt in Diapause (Tag des Jahres)");
			p.InitItem("dr.DiaThr", 15.0, typeof(double), 5.0, 22.0, "Temperaturschwelle für Auslösen d. Diapause");
			p.InitItem("dr.DiaDur", 3, typeof(int), 1.0, 25.0, "Anzahl Tage mit niedrigen Temp. für Auslösen d. Diapause");
		...
		public override bool PrepareWeatherData()
		{
			...
			//Weather.WindSpeedAdjustment = (Double)_workingParams.GetValue("dr.AdjWind");
			Weather.UseSummerSoil= (bool)_workingParams.GetValue("dr.UseSummerSoil");
