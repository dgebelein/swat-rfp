...
namespace swatSim
{
	public class ModelDA : ModelBase
	{
		...
		public override SimParamData GetDefaultParams()
		{
			...
			p.InitItem("da.SummerSoilRel", 0.5, typeof(double), 0.0, 1.0, "Gewichtung Boden-/Lufttemp ab 1.6.", 1); //0= 0%Boden, 100%Luft; 0.5= (Boden +Luft)/2; 1= 100% Boden
			...
			p.InitItem("da.TransWiPupa", 6.0, typeof(double), 5.0, 50.0, "Faktor Transition Überwinterungsstadium->Adult", 3);
			p.InitItem("da.TransEgg", 7.0, typeof(double), 7.0, 50.0, "Faktor Transition Ei->Larve", 3);
			p.InitItem("da.TransLarva", 7.0, typeof(double), 7.0, 50.0, "Faktor Transition Larve->Puppe", 3);
			p.InitItem("da.TransPupa", 7.0, typeof(double), 7.0, 50.0, "Faktor Transition Puppe->Adult", 3);
			p.InitItem("da.TransFly", 4.0, typeof(double), 7.0, 50.0, "Faktor Transition Adult->Tod", 3);
			...
			p.InitItem("da.FertPost", 0.28, typeof(double), 0.0, 0.5, "Fertilität: Post-Oviposition", 3);
			...
			p.InitItem("da.FertCluster", 1, typeof(int), 1.0, 10.0, "Fertilität: Eiablage-Cluster", 3);
		...
		{
			get { return (int)_workingParams.GetValue("da.FertCluster"); }
		}
