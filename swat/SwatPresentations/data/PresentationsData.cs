...
namespace SwatPresentations
{
	...
	public class PresentationsData
	{
		...
		protected double _zoomX0;
		protected double _zoomX1;
		protected double _zoomYL0;
		protected double _zoomYL1;
		protected double _zoomYR0;
		protected double _zoomYR1;
		protected bool _isZoomed;

		public TtpTime DisplayTime { get; set; }
		public double AgeClassMaxVal { get; set; }
		...
		public PresentationsData()
		{
			...
			//_dataSets = new List<PresentationXY>();
			_leftAxisInfo = new TtpScaleInfo(TtpEnAxis.Left);
			_rightAxisInfo = new TtpScaleInfo(TtpEnAxis.Right);
		...
		public int NumRows
		{
			get { return _dataRows.Count; }
		}

		public Double ZoomX0
		{
			get { return _zoomX0; }
			set { _zoomX0 = value; }
		}
		...
		//public void AddSet(PresentationXY set)
		//{
		//	_dataSets.Add(set);
		//}
		...
		private Double GetYDistance( PresentationRow row,ChartGrid chart, int index, Double yPos)
		{
			...
			if (Double.IsNaN(val)|| (val == 0.0))
				...
				//return Math.Abs(yPos - chart.NormalizeY(val, TtpEnAxis.Left));
		...
		public void CreateXYLegendPanel(StackPanel panel, TtpEnAxis axis,
												  Double widthSymbolColumn, Double widthTextColumn,
												  Brush textColor)
		{
			panel.Children.Clear();
		...
		public void CreateXLegend(Grid grid, Brush textColor)
		{
			grid.Children.Clear();
